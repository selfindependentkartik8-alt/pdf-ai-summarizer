...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "WebApplication",
      "@id":
        "https://pdfaisummarizer.krishaiworks.com/#webapplication",
    ...
    {
      "@type": "WebPage",
      "@id": "https://pdfaisummarizer.krishaiworks.com/#webpage",
      url: "https://pdfaisummarizer.krishaiworks.com/",
      name: "PDF AI Summarizer | Summarize PDFs with AI",
      description:
        "Summarize PDF documents quickly with AI. Upload a PDF and get concise, useful summaries in seconds.",
      isPartOf: {
        "@id": "https://krishaiworks.com/#website",
